...
public class Lesson_3_grammar_2_results extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String answersJson = readRawTextFile(context, getResources().getIdentifier("l3_g2_answersjson", "raw", "com.popkova.russianlanguageapp"));
        for (int i = 0; i < 15; i++) {
            String answerReceived = getIntent().getExtras().getString("L3G2A" + Integer.toString(i));
            try {
                JSONObject jsonObject = new JSONObject(answersJson);
                String answerTrue = jsonObject.getString("L3G2A" + Integer.toString(i));
                String totalString = jsonObject.getString("L3G2A" + Integer.toString(i)+"total");
                if (answerTrue.equals(answerReceived.toLowerCase())) {
                    ...
                    if (answerReceived.length() != 0) {
                        String id = "L3G2A" + Integer.toString(i);
                        ...
                        RequestQueue queue = Volley.newRequestQueue(Lesson_3_grammar_2_results.this);
