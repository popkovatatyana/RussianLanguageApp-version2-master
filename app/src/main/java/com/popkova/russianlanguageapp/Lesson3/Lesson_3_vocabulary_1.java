...
public class Lesson_3_vocabulary_1 extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lesson_3_vocabulary_1);
    ...
    private class MyFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return PageFragment_lesson3_v1.newInstance(position);
        }
