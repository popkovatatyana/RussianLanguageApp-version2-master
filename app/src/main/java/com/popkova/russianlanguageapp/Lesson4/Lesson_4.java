...
import com.popkova.russianlanguageapp.Lesson3.Lesson_3_grammar_1;
import com.popkova.russianlanguageapp.Lesson3.Lesson_3_grammar_3;
...
public class Lesson_4 extends AppCompatActivity {
    ...
    private String[] mVocabulary = new String[]{"Город|City"};
    private String[] mGrammar = new String[]{ "Предложный падеж|Prepositional case"};
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                if (groupPosition == 0 && childPosition == 0) {
                    Intent intent = new Intent(Lesson_4.this, Lesson_4_vocabulary_1.class);
                    startActivity(intent);
                }
                if (groupPosition == 1 && childPosition == 0) {
                    Intent intent = new Intent(Lesson_4.this, Lesson_4_grammar_1.class);
                    startActivity(intent);
                }
