...
public class Lesson_8_grammar_2_results extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String answersJson = readRawTextFile(context, getResources().getIdentifier("l8_g2_answersjson", "raw", "com.popkova.russianlanguageapp"));
        for (int i = 0; i < 10; i++) {
            String answerReceived = getIntent().getExtras().getString("L8G2A" + Integer.toString(i));
            try {
                JSONObject jsonObject = new JSONObject(answersJson);
                String answerTrue = jsonObject.getString("L8G2A" + Integer.toString(i));
                String totalString = jsonObject.getString("L8G2A" + Integer.toString(i)+"total");
