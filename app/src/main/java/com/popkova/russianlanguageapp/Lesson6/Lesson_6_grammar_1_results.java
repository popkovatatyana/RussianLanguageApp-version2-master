...
public class Lesson_6_grammar_1_results extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String answersJson = readRawTextFile(context, getResources().getIdentifier("l6_g1_answersjson", "raw", "com.popkova.russianlanguageapp"));
        for (int i = 0; i < 15; i++) {
            String answerReceived = getIntent().getExtras().getString("L6G1A" + Integer.toString(i));
            try {
                JSONObject jsonObject = new JSONObject(answersJson);
                String answerTrue = jsonObject.getString("L6G1A" + Integer.toString(i));
                String totalString = jsonObject.getString("L6G1A" + Integer.toString(i)+"total");
                if (answerTrue.equals(answerReceived.toLowerCase())) {
                    ...
                    if (answerReceived.length() != 0) {
                        String id = "L6G1A" + Integer.toString(i);
                        ...
                        RequestQueue queue = Volley.newRequestQueue(Lesson_6_grammar_1_results.this);
