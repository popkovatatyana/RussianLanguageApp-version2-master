...
public class Lesson_10 extends AppCompatActivity {
    ...
    private String[] mVocabulary = new String[]{"Месяцы и праздники|Months & Festivals"};
    private String[] mGrammar = new String[]{ "Творительный падеж|Instrumental case", "Рефлексивное местоимение себя|Reﬂexive Pronoun" };
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                if (groupPosition == 0 && childPosition == 0) {
                    Intent intent = new Intent(Lesson_10.this, Lesson_10_vocabulary_1.class);
                    startActivity(intent);
                }
                if (groupPosition == 1 && childPosition == 0) {
                    Intent intent = new Intent(Lesson_10.this, Lesson_10_grammar_1.class);
                    startActivity(intent);
                }
                if (groupPosition == 1 && childPosition == 1) {
                    Intent intent = new Intent(Lesson_10.this, Lesson_10_grammar_2.class);
                    startActivity(intent);
                }
